...
латинецей, то они равны, потому что коды символов...
...
key. Им должен быть вызываемый объект, который принимает очередной
элемент (в нашем случае словарь) и возвращает значение-критерий
сортировки.
...
Ключом словаря может быть любой неименяемый объект: число, строка,
